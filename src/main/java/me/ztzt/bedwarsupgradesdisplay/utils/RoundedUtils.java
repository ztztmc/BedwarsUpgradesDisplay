...
public class RoundedUtils {
    ...
    public static ShaderUtils roundedShader = new ShaderUtils("shaders/roundedRect.frag");
    public static ShaderUtils roundedOutlineShader = new ShaderUtils("shaders/roundRectOutline.frag");
    private static ShaderUtils roundedTexturedShader = new ShaderUtils("shaders/roundRectTextured.frag");
