...
public class ShaderUtils {
    ...
    public ShaderUtils(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        try {
            int fragmentShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("bwupgrades", fragmentShaderLoc)).getInputStream(), GL_FRAGMENT_SHADER);;
            glAttachShader(program, fragmentShaderID);

            int vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("bwupgrades", vertexShaderLoc)).getInputStream(), GL_VERTEX_SHADER);
